...
const details = [
    { title: "From", data: "Lagos, Nigeria", style: "inline" },
    { title: "Lives in", data: "Lagos, Nigeria", style: "inline" },
    { title: "Age", data: "23", style: "inline" },
    { title: "Gender", data: "Male", style: "hidden" },
]
                    ...
                    {details.map((detail, index) => (
                        <div className="flex flex-col items-start justify-start" key={index}>
                            <div className="flex flex-row items-center">
                                <div className="w-6 h-6 rounded-full border-4 border-[var(--red-1)]"></div>
                                <p className="text-[var(--gray-5)] dark:text-[var(--gray-4)] font-bold ml-2">{detail.title} :</p>
                                <p className="ml-1">{detail.data}</p>
                            </div>
